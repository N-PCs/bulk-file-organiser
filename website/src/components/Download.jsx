...
const platforms = [
  ...
  },
  {
    ...
    cli: ['sudo apt install libfltk1.3-dev   # Ubuntu', 'sudo dnf install fltk-devel           # Fedora', './build.sh && ./urfiles ~/Downloads --dry-run'],
  },
  {
    id: 'mac',
    name: 'macOS',
    icon: IconDownload,
    zipName: 'urFiles-macos.tar.gz',
    description: 'Native macOS experience via FLTK. Requires Homebrew for dependencies.',
    contents: [
      'urfiles — Native macOS binary (FLTK GUI + CLI)',
      'config.json — Customizable sorting rules',
    ...
    cli: ['brew install fltk', 'chmod +x build_mac.sh', './build_mac.sh && ./urfiles ~/Downloads --dry-run'],
  },
]

// gui.cpp now delegated to gui_win32.cpp (Windows) or gui_fltk.cpp (Linux/macOS)
// Windows: build.bat compiles gui_win32.cpp
// Linux:   build.sh compiles gui_fltk.cpp + core.cpp
// macOS:   build_mac.sh compiles gui_fltk.cpp + core.cpp
//
...
#else
#  error "Use build.sh (Linux) or build_mac.sh (macOS) which compile gui_fltk.cpp directly."
#endif
